...
class gsp_app42PaaSGrailsSampleindex_gsp extends GroovyPage {
...
invokeTag('link','g',114,['url':("http://app42paas.shephertz.com/dev-center/getting-started"),'target':("_blank"),'alt':("Get Started")],2)
createClosureForHtmlPart(21, 2)
invokeTag('link','g',114,['url':("https://paashq.shephertz.com"),'target':("_blank"),'alt':("AppHQ Console")],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1442209520825L
